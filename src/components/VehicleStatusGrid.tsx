  ...
  switch (status) {
    ...
    case "critical":
      return (
        <Badge
          variant="destructive"
          className="bg-critical/20 text-critical border-critical"
        >
          Critical
        </Badge>
      );
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete information about this vehicle and its TEE security
              status
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {formatDistanceToNow(
                        new Date(selectedVehicle.last_update),
                        { addSuffix: true }
                      )}
                    </p>
                  </div>
              ...
              <div className="p-4 rounded-lg border border-border bg-card/50">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-bold">
                    {Math.round(
                      (selectedVehicle.tee_secure / selectedVehicle.tee_total) *
                        100
                    )}
                    %
                  </span>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  {selectedVehicle.tee_secure} out of{" "}
                  {selectedVehicle.tee_total} TEEs are operating securely
                </p>
              </div>
            </div>
          )}
